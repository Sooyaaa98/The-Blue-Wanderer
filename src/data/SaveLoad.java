...
public class SaveLoad {
	...
	public void save() {
		...
		try {
			...
			ds.changedSpeedAfterEquippingBoots = gp.player.changedSpeedAfterEquippingBoots;
			...
			System.out.println("Data Save Exception!");
			e.printStackTrace();
		}
	}
	...
	public void load() {
		...
		try {
			...
			gp.player.changedSpeedAfterEquippingBoots = ds.changedSpeedAfterEquippingBoots;
			
			// Changing speed if boots were equipped
			if(gp.player.changedSpeedAfterEquippingBoots != 0)
				gp.player.speed = gp.player.changedSpeedAfterEquippingBoots;
			...
			System.out.println("Data Load Exception!");
			e.printStackTrace();
		}
